...
namespace SOLID_Principles
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            PhoneAccessoryRepair phoneAccessoryRepair = new PhoneAccessoryRepair();
            ...
            switch(processOption)
            {
                ...
                case "repair":
                    ...
                    if(productType.Equals("phone"))
                    {
                        Console.WriteLine("Please provide the phone model name");
                        productDetail = Console.ReadLine().Trim();
                        phoneAccessoryRepair.ProcessPhoneRepair(productDetail);
                    }
                    else
                    {
                        Console.WriteLine("Please provide the accessory detail, like headphone, tempered glass");
                        productDetail = Console.ReadLine().Trim();
                        phoneAccessoryRepair.ProcessAccessoryRepair(productDetail);
                    }
                    break;
                default:
                    break;
